...
// Runnable, compile-checked examples that back the DocC documentation. Run one against a
// reachable PostgreSQL with `swift run PerunPGSQLExamples <scenario>`; connection settings
// come from the standard PG* environment variables (see Support.swift).
...
default:
    print("usage: swift run PerunPGSQLExamples <scenario>")
